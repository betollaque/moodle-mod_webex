...
/**
 * webex module upgrade related helper functions
 *
 * @package    mod
 * @subpackage webex
...
/**
 * Migrate webex module data from 1.9 resource_old table to new webex table
 * @return void
 */
function webex_20_migrate() {
    global $CFG, $DB;
    ...
    foreach ($candidates as $candidate) {
        ...
        if (!$url = resource_migrate_to_module('webex', $candidate, $url)) {
            continue;
        }
    }
